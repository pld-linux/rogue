...
Gra czerpiąca z Dungeons and Dragons używająca znakowej grafiki,
napisana pod Uniksem BSD, a następnie portowana na inne systemy
uniksowe. Początkowa biblioteka obsługi ekranu 'curses (3)' była
hackowana wspólnie z Kenem Arnoldem głównie by wspierać gry, a rozwój
'rogue (6)' spopularyzował ją. Nethack, Omega, Larn, Angband i cały
podgatunek lochowych gier komputerowych (znanych jako 'roguelike')
czerpią inspirację z 'rogue (6)'. Popularna gra Diablo, mimo ogromnego
ładunku grafiki, ma bardzo podobną logikę gry.
